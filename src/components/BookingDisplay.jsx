...
const BookingsDisplay = () => {
  ...
  const fetchBookings = async () => {
    try {
      ...
      const response = await fetch('https://stallionsls.com/api/bookings/current', {
        headers: {
  ...
  const handleUpdateBooking = async (bookingId, updatedData) => {
    try {
      ...
      const response = await fetch(`https://stallionsls.com/api/bookings/${bookingId}`, {
        method: 'PUT',
        headers: {
  ...
  const handleCancelBooking = async (bookingId) => {
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`https://stallionsls.com/api/bookings/${bookingId}/cancel`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`
        }
